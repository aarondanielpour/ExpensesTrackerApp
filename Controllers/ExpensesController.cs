...
namespace ExpensesTrackerApp.Controllers
{
    ...
    {
        private readonly ExpensesTrackerAppContext _context;

        public ExpensesController(ExpensesTrackerAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Category,Amount,Date,Description")] Expense expense)
        {
